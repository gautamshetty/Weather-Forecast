...
public abstract class NdfdXMLCallbackHandler {
    ...
    public void receiveResultlatLonListZipCode(
        gov.weather.graphical.xml.dwmlgen.wsdl.ndfdxml_wsdl.NdfdXMLStub.LatLonListZipCodeResponse result) {
    }
    ...
    public void receiveResultcornerPoints(
        gov.weather.graphical.xml.dwmlgen.wsdl.ndfdxml_wsdl.NdfdXMLStub.CornerPointsResponse result) {
    }
    ...
    public void receiveResultlatLonListSquare(
        gov.weather.graphical.xml.dwmlgen.wsdl.ndfdxml_wsdl.NdfdXMLStub.LatLonListSquareResponse result) {
    }
    ...
    public void receiveResultnDFDgenByDayLatLonList(
        gov.weather.graphical.xml.dwmlgen.wsdl.ndfdxml_wsdl.NdfdXMLStub.NDFDgenByDayLatLonListResponse result) {
    }
    ...
    public void receiveResultnDFDgen(
        gov.weather.graphical.xml.dwmlgen.wsdl.ndfdxml_wsdl.NdfdXMLStub.NDFDgenResponse result) {
    }
    ...
    public void receiveResultnDFDgenByDay(
        gov.weather.graphical.xml.dwmlgen.wsdl.ndfdxml_wsdl.NdfdXMLStub.NDFDgenByDayResponse result) {
    }
    ...
    public void receiveResultgmlTimeSeries(
        gov.weather.graphical.xml.dwmlgen.wsdl.ndfdxml_wsdl.NdfdXMLStub.GmlTimeSeriesResponse result) {
    }
    ...
    public void receiveResultlatLonListSubgrid(
        gov.weather.graphical.xml.dwmlgen.wsdl.ndfdxml_wsdl.NdfdXMLStub.LatLonListSubgridResponse result) {
    }
    ...
    public void receiveResultlatLonListLine(
        gov.weather.graphical.xml.dwmlgen.wsdl.ndfdxml_wsdl.NdfdXMLStub.LatLonListLineResponse result) {
    }
    ...
    public void receiveResultnDFDgenLatLonList(
        gov.weather.graphical.xml.dwmlgen.wsdl.ndfdxml_wsdl.NdfdXMLStub.NDFDgenLatLonListResponse result) {
    }
    ...
    public void receiveResultlatLonListCityNames(
        gov.weather.graphical.xml.dwmlgen.wsdl.ndfdxml_wsdl.NdfdXMLStub.LatLonListCityNamesResponse result) {
    }
    ...
    public void receiveResultgmlLatLonList(
        gov.weather.graphical.xml.dwmlgen.wsdl.ndfdxml_wsdl.NdfdXMLStub.GmlLatLonListResponse result) {
    }
